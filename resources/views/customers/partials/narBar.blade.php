        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item mx-2 active"><a class="nav-link" href="#"><i class="fa fa-home mr-1"></i>Trang Chủ</a></li>
                    <li class="nav-item mx-2 dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#"><i class="fa fa-users icon-highlight"></i> Tầm nhìn & Sứ mệnh</a>
                            <a class="dropdown-item" href="#"><i class="fa fa-users icon-highlight"></i> Đội ngũ</a>
                            <a class="dropdown-item" href="#"><i class="fa fa-users icon-highlight"></i> Giá trị cốt lõi</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item mx-2 dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#"><i class="fa fa-cog mr-1 icon-highlight"></i> Giấy phép xây dựng</a>
                            <a class="dropdown-item" href="#"><i class="fa fa-cog mr-1 icon-highlight"></i> Thiết kế kiến trúc, nội thất</a>
                            <a class="dropdown-item" href="#"><i class="fa fa-cog mr-1 icon-highlight"></i> Xây dựng phần thô</a>
